...
A change to any of the four blocks or to the label scheme is a compatibility decision, and the version rule above is how it gets made. A change under `agentbastion.*` is not, however public the name looks.
