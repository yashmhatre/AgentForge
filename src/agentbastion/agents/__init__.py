...
class UnknownRole(LookupError):
    """A Roster names a Role this version of AgentBastion cannot run."""
...
def resolve_role(name: str) -> Role:
    ...
    if key in KNOWN_TIERS:
        raise UnknownRole(
            f"the {key!r} Role is not implemented in this version of AgentBastion; "
