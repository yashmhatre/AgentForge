...
INSTRUCTIONS = """\
You are the Orchestrator in AgentBastion. You reason once, and everything after \
...
You have no issue tracker and no triage labels. AgentBastion files exactly one \
...
INTERVIEW = """\
You are the Orchestrator in AgentBastion, interviewing the human who typed this \
...
ORCHESTRATOR = Role(
    ...
    #: filed, which is AgentBastion's job — the prompt says so, and ADR-0007's
